...
public class HeroKnight : MonoBehaviour {
    ...
    void Start ()
    {
        ...
        defaultAttackPoint = attackPoint.transform.position;
    }
    ...
    void Update ()
    {
        ...
        {
            if (currentTravelTime > travelTimer)
            {
        ...
        else if (Input.GetMouseButtonDown(1) && !m_rolling)
        {
            ...
            if (canRangedAttack)
            {
                ...
                if (this.GetComponent<SpriteRenderer>().flipX)
                {
                    Vector2 playerPos = new Vector2(this.transform.position.x - 0.2f, this.transform.position.y + 1f);
                    rangedAttack = Instantiate(bubblePrefab, playerPos, Quaternion.identity);
                    rangedAttack.GetComponent<Rigidbody2D>().velocity = new Vector2(-8f, 0f);
                }
                else
                {
                    Vector2 playerPos = new Vector2(this.transform.position.x + 0.2f, this.transform.position.y + 1f);
